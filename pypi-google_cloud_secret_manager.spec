...
Version  : 2.22.1
Release  : 29
URL      : https://files.pythonhosted.org/packages/8c/ba/c95de678ebfa42075b717b9645341b1ae180d81442248100d21b2eba1a0c/google_cloud_secret_manager-2.22.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/8c/ba/c95de678ebfa42075b717b9645341b1ae180d81442248100d21b2eba1a0c/google_cloud_secret_manager-2.22.1.tar.gz
...
%prep
%setup -q -n google_cloud_secret_manager-2.22.1
cd %{_builddir}/google_cloud_secret_manager-2.22.1
pushd ..
cp -a google_cloud_secret_manager-2.22.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737076073
