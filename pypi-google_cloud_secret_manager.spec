...
Source0  : https://files.pythonhosted.org/packages/0d/db/9bea73b1f66962b3ce96e606f2e9a4233f079cc3c270fceddaefe2c05f84/google-cloud-secret-manager-2.16.0.tar.gz
...
%prep
%setup -q -n google-cloud-secret-manager-2.16.0
cd %{_builddir}/google-cloud-secret-manager-2.16.0
pushd ..
cp -a google-cloud-secret-manager-2.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677625908
