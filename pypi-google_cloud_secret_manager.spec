...
Source0  : https://files.pythonhosted.org/packages/c4/0c/52d1fdc9704f60886d0e60b98527d799b8cf43d785fd2896d8c8be3e5a0c/google-cloud-secret-manager-2.18.3.tar.gz
...
%prep
%setup -q -n google-cloud-secret-manager-2.18.3
cd %{_builddir}/google-cloud-secret-manager-2.18.3
pushd ..
cp -a google-cloud-secret-manager-2.18.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709739719
