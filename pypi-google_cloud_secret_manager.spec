...
Source0  : https://files.pythonhosted.org/packages/63/c1/7143d768aad3daba249ab08ba3f9eb265dcdcc3b3de84f8d94daaf2fe07a/google-cloud-secret-manager-2.19.0.tar.gz
...
%prep
%setup -q -n google-cloud-secret-manager-2.19.0
cd %{_builddir}/google-cloud-secret-manager-2.19.0
pushd ..
cp -a google-cloud-secret-manager-2.19.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711239877
