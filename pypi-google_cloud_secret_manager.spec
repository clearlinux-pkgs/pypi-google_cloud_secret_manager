...
%prep
%setup -q -n google-cloud-secret-manager-2.17.0
cd %{_builddir}/google-cloud-secret-manager-2.17.0
pushd ..
cp -a google-cloud-secret-manager-2.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702924187
