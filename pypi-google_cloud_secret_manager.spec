...
Version  : 2.22.0
Release  : 28
URL      : https://files.pythonhosted.org/packages/05/4a/985b3dafcf235198e06460ecf1b2a41ae3810c006a629d723292b06425a0/google_cloud_secret_manager-2.22.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/05/4a/985b3dafcf235198e06460ecf1b2a41ae3810c006a629d723292b06425a0/google_cloud_secret_manager-2.22.0.tar.gz
...
%prep
%setup -q -n google_cloud_secret_manager-2.22.0
cd %{_builddir}/google_cloud_secret_manager-2.22.0
pushd ..
cp -a google_cloud_secret_manager-2.22.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735095817
