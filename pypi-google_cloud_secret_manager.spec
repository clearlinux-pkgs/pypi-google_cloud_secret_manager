...
Source0  : https://files.pythonhosted.org/packages/50/f3/c08151cb660637952f5562551c0b325b969515888620d887a77fdbab9659/google-cloud-secret-manager-2.18.0.tar.gz
...
%prep
%setup -q -n google-cloud-secret-manager-2.18.0
cd %{_builddir}/google-cloud-secret-manager-2.18.0
pushd ..
cp -a google-cloud-secret-manager-2.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706824314
