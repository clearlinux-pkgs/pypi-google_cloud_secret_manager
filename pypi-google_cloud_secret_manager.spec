...
Version  : 2.23.3
Release  : 34
URL      : https://files.pythonhosted.org/packages/99/73/533fca3a94ef6cf57fbd0cf6fa57c8865ba8173542a505272869a1b7be85/google_cloud_secret_manager-2.23.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/99/73/533fca3a94ef6cf57fbd0cf6fa57c8865ba8173542a505272869a1b7be85/google_cloud_secret_manager-2.23.3.tar.gz
...
%prep
%setup -q -n google_cloud_secret_manager-2.23.3
cd %{_builddir}/google_cloud_secret_manager-2.23.3
pushd ..
cp -a google_cloud_secret_manager-2.23.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744994039
